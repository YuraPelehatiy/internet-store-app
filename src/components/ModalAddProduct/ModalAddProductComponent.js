...
const ModalAddProductComponent = ({ title, description, image, price, onSubmitAdd, onChangeField, openModal, onClose, showModalStatus }) => (
    <Modal open={showModalStatus} onClose={onClose} center>
...
ModalAddProductComponent.propTypes = {
    ...
    showModalStatus: T.bool.isRequired,
